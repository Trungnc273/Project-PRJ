<%-- 
    ...
    Created on : 10 thg 10, 2024, 19:04:27
    Author     : TRUNG
--%>
    ...
    <head>
        ...
        <style>
            .table td {
                ...
                max-width: 150px; /* Điều chỉnh chiều rộng tối đa theo nhu cầu */
            }
        </style>
    </head>
            ...
            <div class="container-scroller">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <% } %>
                                    <li class="nav-item">
                                        <a class="nav-link" href="ordercrud?role=<%= account.getRole() %>&id=<%= account.getId() %>">Order</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        ...
                        <jsp:include page="OrderCRUD.jsp"></jsp:include>
                        </div>
