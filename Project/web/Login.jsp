<%-- 
    Document   : Login
    Created on : 9 thg 10, 2024, 15:21:14
    Author     : TRUNG
--%>
...
<%
    ...
    boolean isChecked = signupParam != null && signupParam.equals("true");
%>
<!doctype html>
<html lang="en">
                    ...
                    <div class="row full-height justify-content-center">
                        <div class="col-12 text-center align-self-center py-5">
                            <div class="section pb-5 pt-5 pt-sm-2 text-center">
                                ...
                                <input class="checkbox" type="checkbox" id="reg-log" name="reg-log"<% if (isChecked) { %>checked<% } %>/>
                                                ...
                                                <form action="login" method="post">
                                                    <div class="svgContainer">
                                                        <div>
                                                            ...
                                                            <g class="earR">
                                                            <g class="outerEar">
                                                            <circle fill="#DDF1FA" stroke="#3A5E77"
                                                                    stroke-width="2.5" cx="153" cy="83" r="11.5" />
                                                            <path fill="#DDF1FA" stroke="#3A5E77"
                                                                  stroke-width="2.5" stroke-linecap="round"
                                                                  stroke-linejoin="round"
                                                            ...
                                                            <rect x="134" y="64" fill="#FFFFFF" width="15"
                                                                  height="35" />
                                                            <path fill="#FFFFFF" stroke="#3A5E77"
                                                                  stroke-width="2.5" stroke-linecap="round"
                                                                  stroke-linejoin="round"
                                                            ...
                                                            <path style="display: none;" class="mouthSmallBG"
                                                                  fill="#617E92"
                                                                  d="M100.2,101c-0.4,0-1.4,0-1.8,0c-2.7-0.3-5.3-1.1-8-2.5c-0.7-0.3-0.9-1.2-0.6-1.8 c0.2-0.5,0.7-0.7,1.2-0.7c0.2,0,0.5,0.1,0.6,0.2c3,1.5,5.8,2.3,8.6,2.3s5.7-0.7,8.6-2.3c0.2-0.1,0.4-0.2,0.6-0.2 c0.5,0,1,0.3,1.2,0.7c0.4,0.7,0.1,1.5-0.6,1.9c-2.6,1.4-5.3,2.2-7.9,2.5C101.7,101,100.5,101,100.2,101z" />
                                                            ...
                                                            <ellipse class="tongueHighlight" cx="100"
                                                                     cy="100.5" rx="3" ry="1.5" opacity=".1"
                                                                     fill="#fff" />
                                                            </g>
                                                            </g>
                                                            ...
                                                            <polygon fill="#DDF1FA" stroke="#3A5E77"
                                                                     stroke-width="2.5" stroke-linecap="round"
                                                    ...
                                                    <div class="form-group" id="loginEmailLabel">
                                                        <input type="text" class="form-style" id="loginEmail"
                                                               maxlength="254" placeholder="Email or Phone Number" name="useraccount">
                                                        <i class="input-icon uil uil-user"></i>
                                                    </div>

                                                    <label id="showPasswordToggle" for="showPasswordCheck"
                                                           style="display: flex; align-items: center; margin:0 0 -10px 240px;">
                                                    ...
                                                    <div class="form-group mt-2" id="loginPasswordLabel">
                                                        <input type="password" class="form-style" id="loginPassword"
                                                               placeholder="Password" name="password">
                                                        <i class="input-icon uil uil-lock-alt"></i>
                                                    </div>
                                                    <p style="position: absolute; left: 190px;
                                                       bottom: 148px;" class="mb-0 mt-4 text-center"><a href="ForgotPassword.jsp"
                                                                                       class="link">Forgot your
                                                            password?</a></p>
                                                    <div style="height: 10px;"></div>
                                                    <button type="submit" style="border-radius: 4px; height: 44px; font-size: 13px; font-weight: 600; text-transform: uppercase;
                                                            padding: 0 30px; letter-spacing: 1px; display: inline-flex;
                                                            align-items: center; background-color: #bf1e2c; color: #000000;" class="btn mt-4">Sign In</button>
                                        ...
                                        <div class="center-wrap">
                                            <div class="section text-center">
                                                <form action="signup" method="post">
                                                    <h4 style="color: #bf1e2c;" class="mb-3 pb-3">Sign Up</h4>
                                                    ...
                                                    <button type="submit" style="border-radius: 4px; height: 44px; font-size: 13px; font-weight: 600; text-transform: uppercase;
                                                            padding: 0 30px; letter-spacing: 1px; display: inline-flex;
                                                            align-items: center; background-color: #bf1e2c; color: #000000;" class="btn mt-4">Sign Up</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
